                ...
                <div class="row justify-content-around">
                    <div class="col-7 p-0 pokemon-details position-relative" :style="`background-color: ${getBadgeColor(store.pokemons[activeIndex]?.types[0].type.name)}`" style="height: 90vh;">
                        ...
                        <div class="d-flex h-50 flex-column justify-content-between position-relative" style="border-top-left-radius: 25px; border-top-right-radius: 25px;">
                            ...
                            <img v-if="!shiny" :src="store.pokemons[activeIndex]?.sprites.other.home.front_default" class="position-relative align-self-center" style="width: 300px; transform: translateY(50px); z-index: 1000;" alt="pokemon image">
                            <img v-else :src="store.pokemons[activeIndex]?.sprites.other.home.front_shiny" class="position-relative align-self-center" style="width: 300px; transform: translateY(50px); z-index: 1000;" alt="pokemon image">
                        </div>
